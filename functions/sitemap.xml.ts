...
const STATIC_PAGES: { loc: string; priority: string; changefreq: string }[] = [
  ...
  { loc: "/laptop-desktop-rentals", priority: "0.8", changefreq: "monthly" },
  { loc: "/smartphone-rentals", priority: "0.8", changefreq: "monthly" },
  { loc: "/headphones-audio-rentals", priority: "0.8", changefreq: "monthly" },
  { loc: "/camera-gear-rentals", priority: "0.8", changefreq: "monthly" },
  { loc: "/router-rentals", priority: "0.8", changefreq: "monthly" },
  { loc: "/html-sitemap", priority: "0.5", changefreq: "weekly" },
  ...
  { loc: "/collections/laptops", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/desktops", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/workstations", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/smartphones", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/mobile-phones", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/cell-phones", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/headphones", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/keyboards", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/computer-mice", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/dslr-cameras", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/camera-lenses", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/lighting-gear", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/routers", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/wifi-routers", priority: "0.7", changefreq: "weekly" },
  { loc: "/collections/wireless-routers", priority: "0.7", changefreq: "weekly" },
];
